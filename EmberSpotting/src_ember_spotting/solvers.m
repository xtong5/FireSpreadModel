...
velx = psix + etay;  %+ exprnd(o.s,o.N,o.N);
vely = psiy - etax + o.s; %+ exprnd(o.s,o.N,o.N); %v*arrival time 
...
%  pause
  ...
  idx = indx(1); idy = indy(1); %consider the ember attack
  indx = indx(2:end); % cells along bresenham line 
  indy = indy(2:end); % cells along bresenham line 

  % Add Ember spots
%   rddist = 0;
  rddist = o.s*normrnd(20,5,1)*binornd(1,0.01,1);
  if rddist ~= 0
    indx = [indx; idx];
