...
topo = randTerrain(5, prams.N);
topo2 = rot90(fliplr(1-topo)); % correct for plotting issues
...
while time < prams.T && nnz(cells.state == 2)
  ...
  trueVelx = cells.velx ./ topo;
  trueVely = cells.vely ./ topo;
  ...
  subplot(2,2,2)
  horizVel = sqrt(trueVelx.^2 + trueVely.^2);
